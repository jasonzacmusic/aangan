...
export const STATE_META: Record<StudioState, StateMeta> = {
  ...
  class: {
    ...
    houseAction: "Light and screen amber · lesson in progress",
  },
  meeting: {
    label: "Meeting",
    short: "MEET",
    ...
    houseAction: "Light and screen amber · please wait",
  },
  audio_rec: {
    label: "Audio Rec",
    short: "AUDIO",
  ...
  video_rec: {
    ...
    houseAction: "Light and screen red · filming",
  },
  emergency: {
    label: "Emergency",
    short: "SOS",
    ...
    houseAction: "Light and screen violet · do not enter",
  },
};
